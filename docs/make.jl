...
DocMeta.setdocmeta!(DEMOSCompute, :DocTestSetup, :(using DEMOSCompute); recursive = true)
...
makedocs(;
    modules = [DEMOSCompute],
    authors = "Anton Reinhard <a.reinhard@hzdr.de>",
    repo = "https://github.com/Democratizing-Models/DEMOSCompute.jl/blob/{commit}{path}#{line}",
    sitename = "DEMOSCompute.jl",
    format = Documenter.HTML(; canonical = "https://Democratizing-Models.github.io/DEMOSCompute.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/Democratizing-Models/DEMOSCompute.jl")
